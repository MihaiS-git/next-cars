...
export default function CarsPageLayout({
    ...
    return (
        <div className="flex flex-col w-full bg-zinc-800 text-zinc-50 md:w-11/12 md:h-100 rounded-lg border border-red-600 mt-4">
            <h1 className="mb-2 mt-8 text-zinc-400 font-semibold text-xl lg:font-bold lg:text-2xl text-center">
                <em>Welcome to Next Cars</em>
            </h1>
            <p className="mb-8 mt-2 text-zinc-400 font-semibold text-lg lg:font-bold lg:text-xl text-center">
