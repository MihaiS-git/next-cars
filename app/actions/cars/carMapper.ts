...
export const mapCarToFrontend = (car: {
    ...
    mileage: car.mileage,
    carRentalDetails: car.carRentalDetails._id.toString(),
    carFeaturesAndSpecifications: car.carFeaturesAndSpecifications._id.toString(),
    carImagesAndDocuments: car.carImagesAndDocuments._id.toString(),
    rentalAgencyDetails: car.rentalAgencyDetails._id.toString(),
});
